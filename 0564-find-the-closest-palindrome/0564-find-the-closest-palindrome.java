class Solution {
    ...
    public String nearestPalindromic(String n) {
        ...
        */
        ...
        possibleResults.add(halfToPalindrome(firstHalf, l%2 == 0));
        possibleResults.add(halfToPalindrome(firstHalf+1, l%2 == 0));
        possibleResults.add(halfToPalindrome(firstHalf-1, l%2 == 0));
        possibleResults.add((long) Math.pow(10, l-1) -1); // Edge case like 999...
        possibleResults.add((long) Math.pow(10, l) + 1); // Edge case like 100...001
